-- Spring Security Authorization Server 7.1 official JDBC schemas adapted for
-- PostgreSQL: timestamp -> timestamptz and blob -> text.
...
CREATE INDEX oauth2_authorization_registered_client_ix
    ON oauth2_authorization (registered_client_id);
CREATE INDEX oauth2_authorization_principal_ix
    ON oauth2_authorization (principal_name);
CREATE INDEX oauth2_authorization_state_ix
