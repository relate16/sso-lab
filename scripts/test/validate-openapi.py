...
REQUIRED: dict[str, dict[str, set[str]]] = {
    ...
    "auth-internal.json": {
        "/internal/admin/v1/dashboard": {"get"},
        "/internal/admin/v1/users": {"get"},
        "/internal/admin/v1/users/bulk/status": {"post"},
        "/internal/admin/v1/users/bulk/roles": {"put"},
        ...
        "/internal/admin/v1/groups/{groupId}": {"get", "patch", "delete"},
        "/internal/admin/v1/groups/{groupId}/members/{userId}": {"post", "delete"},
    ...
    "admin-server.json": {
        ...
        "/api/v1/admin/users/bulk/status": {"post"},
        "/api/v1/admin/users/bulk/roles": {"put"},
        "/api/v1/admin/users/{userId}/suspend": {"post"},
        "/api/v1/admin/users/{userId}/email/reveal": {"post"},
        "/api/v1/admin/groups": {"get", "post"},
        "/api/v1/admin/groups/{groupId}": {"get", "patch", "delete"},
        "/api/v1/admin/groups/{groupId}/members/{userId}": {"post", "delete"},
